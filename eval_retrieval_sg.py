...
Uso:
    python eval_retrieval_sg.py --query "Pit bulls & other bully-types welcome at 780’s dog motel." --top_k 5 --rerank --rerank_pool "max"
...
def main(args: argparse.Namespace) -> None:
    ...
    # --- Fase 5: salvar visualizações pré-rerank (sempre) ---
    ...
    # --- Fase 6: re-ranking semântico (opcional) — gera visualizações adicionais ---
    if args.rerank:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir",   default="results/sg_viz_anyup")
